...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.taxoLineEdit_3 = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.taxoLineEdit_3.sizePolicy().hasHeightForWidth())
        self.taxoLineEdit_3.setSizePolicy(sizePolicy)
        self.taxoLineEdit_3.setObjectName("taxoLineEdit_3")
        self.horizontalLayout_2.addWidget(self.taxoLineEdit_3)
        self.taxoLineEdit_4 = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.taxoLineEdit_4.sizePolicy().hasHeightForWidth())
        self.taxoLineEdit_4.setSizePolicy(sizePolicy)
        self.taxoLineEdit_4.setText("")
        self.taxoLineEdit_4.setObjectName("taxoLineEdit_4")
        self.horizontalLayout_2.addWidget(self.taxoLineEdit_4)
        self.verticalLayout_2.addLayout(self.horizontalLayout_2)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.taxoLineEdit_5 = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.taxoLineEdit_5.sizePolicy().hasHeightForWidth())
        self.taxoLineEdit_5.setSizePolicy(sizePolicy)
        self.taxoLineEdit_5.setObjectName("taxoLineEdit_5")
        self.horizontalLayout_3.addWidget(self.taxoLineEdit_5)
        self.taxoLineEdit_6 = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.taxoLineEdit_6.sizePolicy().hasHeightForWidth())
        self.taxoLineEdit_6.setSizePolicy(sizePolicy)
        self.taxoLineEdit_6.setText("")
        self.taxoLineEdit_6.setObjectName("taxoLineEdit_6")
        self.horizontalLayout_3.addWidget(self.taxoLineEdit_6)
        ...
        spacerItem = QtWidgets.QSpacerItem(13, 62, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout.addWidget(self.responseGBox, 0, 1, 6, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Физприбор 3.4.13а"))
        ...
        self.requestGBox.setTitle(_translate("MainWindow", "Отправка команда"))
        ...
        self.label_2.setText(_translate("MainWindow", "Параметры калибровки:"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Опрос тахометра"))
        self.label_1.setText(_translate("MainWindow", "Скорость вращения:"))
