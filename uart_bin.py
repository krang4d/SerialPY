...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, *args, obj=None, **kwargs):
        ...
        self.styles = {'color':'b', 'font-size':'14px'}
        self.graphWidget1.setLabel('left', 'RPM', **self.styles)
        self.graphWidget2.setLabel('left', 'T (°C)', **self.styles)
    ...
    def vibro_data_slot(self, t = 2.3):
        ...
        BN … B1 массив 16 разрядных отсчётов АЦП виброметра (N = 2048)

        Запрос повторяется 16 раз подряд.
        Таким образом массив принятых данных составит 16 выборок по 2048 байт данных, где в каждая выборке 1024 16-разрядных целых чисел.
        Как только данные собраны, двигатель останавливается, если в окне установлена соответствующая настройка (CheckBox - 'С остановкой двигателя').
